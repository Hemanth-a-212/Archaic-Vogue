     ...
     return (<>
      ...
      <div className="btn-cont">
        ...
        <div className='navbar'>
         ...
         <img className="nav-drop-icon" onClick={dropdown} src={ham_menu} alt="" />   
         <div ref={menuRef} className={isMenuOpen?"nav-dropdown nav-menu-visible":"nav-dropdown"}>
            ...
            <div className="nav-login-cart">
               ...
               <><img className='user-icon' src={user_icon} alt="" onClick={()=>setIsUserOpen(p=>!p)} />
               <div ref={user_ref} className={isUserOpen?"user-menu-dropdown user-menu-visible":"user-menu-dropdown"}>
               ...
               <Link to='/cart'><img src={cart_icon} alt="Cart icon" onClick={()=>{itemClicked();setmenu("cart")}}/></Link>
               {totalItemsInCart()?<div className="cart-item-count">{totalItemsInCart()}</div>:""}</>
               :
